  ...
  return (
   ...
   <div className="calculator">
    ...
    <div className="buttons">
      ...
      <input type="button" value="DEL" className='btn' onClick={deleteLast}/>
      <input type="button" value="%" className='btn' onClick={() => updateCalc("%")}/>
      <input type="button" value="/" className='btn' onClick={() => updateCalc("/")}/>
      ...
      <input type="button" value="x" className='btn' onClick={() => updateCalc("*")}/>
      ...
      <input type="button" value="=" className='btn equal' onClick={calculate}/>
